...
var Icon$v = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React__default['default'].createElement("image", { width: 90, height: 90, href: "/images/round.png" })));
};
...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 220 50" }, props),
        React__default['default'].createElement("image", { width: "220", height: "50", href: isDark ? "/images/logo-menu-dark.png" : "/images/logo-menu-light.png" })));
};
...
var StyledSvg = styled__default['default'](Svg)(templateObject_1$x || (templateObject_1$x = __makeTemplateObject(["\n  fill: none !important;\n"], ["\n  fill: none !important;\n"])));
var Icon$16 = function (props) {
    ...
    // width="800"
    // height="800"
    , __assign({}, props, { fill: "none", viewBox: "0 0 24 24" }),
        React__default['default'].createElement("path", { stroke: getThemeValue("colors.textSubtle", theme.colors.textSubtle)(theme), strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M21 21H4.6c-.56 0-.84 0-1.054-.109a1 1 0 01-.437-.437C3 20.24 3 19.96 3 19.4V3m18 4l-5.434 5.434c-.198.198-.297.297-.412.334a.499.499 0 01-.309 0c-.114-.037-.213-.136-.41-.334l-1.87-1.868c-.197-.198-.296-.297-.41-.334a.499.499 0 00-.31 0c-.114.037-.213.136-.41.334L7 15m14-8h-4m4 0v4" })));
};
    ...
    return (React__default['default'].createElement(Container$3, null, links.map(function (entry) {
        ...
        if (entry.items) {
            return (React__default['default'].createElement(Accordion, { key: entry.label, isPushed: isPushed, pushNav: pushNav, icon: iconElement, label: entry.label, initialOpenState: entry.initialOpenState, className: calloutClass }, isPushed &&
                entry.items.map(function (item) { return (React__default['default'].createElement(MenuEntry, { key: item.href, secondary: true, isActive: item.href === location.pathname, onClick: handleClick }, item.openTab ? (React__default['default'].createElement(MenuLink, { target: "_blank", href: item.href }, item.label)) : (React__default['default'].createElement(MenuLink, { href: item.href }, item.label)))); })));
        }
...
var WalletCard = function (_a) {
    ...
    return (React__default['default'].createElement(Button, { fullWidth: true, variant: "tertiary", onClick: function () {
        ...
        walletConfig.icon ? (React__default['default'].createElement(walletConfig.icon, { width: "32px" })) : (React__default['default'].createElement(Image, { src: (_b = walletConfig.fallbackImage) !== null && _b !== void 0 ? _b : "images/wallets/other.png", alt: title, width: 32, height: 32 }))));
};
...
var AccountModal = function (_a) {
    ...
    return (React__default['default'].createElement(Modal, { title: "Your wallet", onDismiss: onDismiss },
        ...
        React__default['default'].createElement(Flex, { mb: "32px" },
            React__default['default'].createElement(LinkExternal, { small: true, href: "https://scan.pulsechain.com/address/" + account, mr: "16px" }, "View on Explorer"),
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#ebe9eb", contrast: "#241326", invertedContrast: "#FFFFFF", input: "#f3eaf4", tertiary: "#f4eff5", text: "#bc0fc8", textDisabled: "#c0bdc4", textSubtle: "#ba80b5", borderColor: "#eae9eb", card: "#FFFFFF", gradients: {
        bubblegum: "linear-gradient(139.73deg, #ebe6ff 0%, #fdefff 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#bc0fc8", background: "#353135", backgroundDisabled: "#423742", contrast: "#FFFFFF", invertedContrast: "#261325", input: "#573f5a", primaryDark: "#0098A1", tertiary: "#473542", text: "#f8e2fc", textDisabled: "#6f6171", textSubtle: "#d2c4d4", borderColor: "#634b63", card: "#2c262c", gradients: {
